...
export default function SettingsForm({ locale }: { locale: string }) {
  ...
  const L = {
    details: t(locale, { uk: "Особисті дані", en: "Account Details", ja: "アカウント情報", ar: "بيانات الحساب" }),
    firstName: t(locale, { uk: "Ім'я", en: "First name", ja: "名", ar: "الاسم الأول" }),
    surname: t(locale, { uk: "Прізвище", en: "Surname", ja: "姓", ar: "اسم العائلة" }),
    email: t(locale, { uk: "Електронна пошта", en: "Email", ja: "メールアドレス", ar: "البريد الإلكتروني" }),
    dob: t(locale, { uk: "Дата народження", en: "Date of birth", ja: "生年月日", ar: "تاريخ الميلاد" }),
    save: t(locale, { uk: "Зберегти", en: "Save", ja: "保存する", ar: "حفظ" }),
    password: t(locale, { uk: "Пароль", en: "Password", ja: "パスワード", ar: "كلمة المرور" }),
    newPassword: t(locale, { uk: "Новий пароль", en: "New password", ja: "新しいパスワード", ar: "كلمة مرور جديدة" }),
    pwHint: t(locale, { uk: "Мінімум 8 символів, великі й малі літери та цифра", en: "Min 8 characters, upper & lower case and a number", ja: "8文字以上、大文字・小文字・数字を含む", ar: "8 أحرف على الأقل، حروف كبيرة وصغيرة ورقم" }),
    updatePw: t(locale, { uk: "Оновити пароль", en: "Update password", ja: "パスワードを更新", ar: "تحديث كلمة المرور" }),
    comms: t(locale, { uk: "Налаштування сповіщень", en: "Communication Preferences", ja: "配信設定", ar: "تفضيلات المراسلة" }),
    marketing: t(locale, { uk: "Отримувати новини, пропозиції та переваги учасника", en: "Emails about updates, offers and member benefits", ja: "最新情報、ご案内、会員特典のメール", ar: "رسائل عن المستجدات والعروض ومزايا الأعضاء" }),
    privacy: t(locale, { uk: "Приватність", en: "Privacy", ja: "プライバシー", ar: "الخصوصية" }),
    cookieBody: t(locale, { uk: "Керуйте тим, які файли cookie ми можемо використовувати. Необхідні cookie завжди увімкнені.", en: "Manage which cookies we're allowed to use. Necessary cookies are always on.", ja: "利用する Cookie を管理できます。必須 Cookie は常に有効です。", ar: "تحكّم في ملفات تعريف الارتباط المسموح لنا باستخدامها. الملفات الضرورية تعمل دائمًا." }),
    cookieBtn: t(locale, { uk: "Налаштування cookie", en: "Cookie settings", ja: "Cookie 設定", ar: "إعدادات ملفات تعريف الارتباط" }),
    saved: t(locale, { uk: "Збережено", en: "Saved", ja: "保存しました", ar: "تم الحفظ" }),
    pwUpdated: t(locale, { uk: "Пароль оновлено", en: "Password updated", ja: "パスワードを更新しました", ar: "تم تحديث كلمة المرور" }),
    pwWeak: t(locale, { uk: "Пароль не відповідає вимогам.", en: "Password doesn't meet the requirements.", ja: "パスワードが条件を満たしていません。", ar: "كلمة المرور لا تستوفي المتطلبات." }),
    err: t(locale, { uk: "Не вдалося зберегти. Спробуйте ще раз.", en: "Couldn't save. Please try again.", ja: "保存できませんでした。もう一度お試しください。", ar: "تعذّر الحفظ. حاول مرة أخرى." }),
  };
  ...
  return (
    <div>
      <h1 className="text-3xl font-semibold mb-2" style={{ color: "#111" }}>{t(locale, { uk: "Налаштування", en: "Account Settings", ja: "アカウント設定", ar: "إعدادات الحساب" })}</h1>
