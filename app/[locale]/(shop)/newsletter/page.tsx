      ...
      <div className="page-container pt-32 pb-24">
        <div className="grid lg:grid-cols-[1fr_400px] gap-12 xl:gap-20 items-start">
          ...
          <aside className="w-full lg:sticky lg:top-28">
            ...
            {/* WHAT THE LIST IS ABOUT, where a placeholder used to be. This
                held the About page's dark TCT plate — borrowed art that made
                the rail look furnished without saying anything. The kit
                sequence is the argument the newsletter exists to make, and it
                is the one thing on this page that links to /setup. */}
            <div className={accountEmail ? "" : "mt-6"}>
              <WhatsNextPanel locale={locale} />
            </div>
          </aside>
        </div>
      </div>
