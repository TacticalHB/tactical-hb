...
export default function CartPageClient({
  ...
  const L = {
    ...pick(locale, {
      ...
      empty: { uk: "У вашому кошику поки що порожньо.", en: "Your shopping bag is currently empty.", ja: "バッグにはまだ何も入っていません。", ar: "حقيبتك فارغة حاليًا." },
      emptyHint: {
        ...
        ar: "أضف قطعة — أو كوّن طقمًا كاملًا دفعة واحدة.",
      },
      buildSetup: { uk: "Зібрати сет", en: "Build a setup", ja: "セットを組む", ar: "كوّن طقمًا" },
      browse: { uk: "Перейти до товарів", en: "Continue shopping", ja: "買い物を続ける", ar: "متابعة التسوّق" },
      summary: { uk: "Підсумок замовлення", en: "Order Summary", ja: "ご注文内容", ar: "ملخّص الطلب" },
      subtotal: { uk: "Проміжний підсумок", en: "Subtotal", ja: "小計", ar: "المجموع الفرعي" },
      shipping: { uk: "Доставка", en: "Shipping", ja: "配送", ar: "الشحن" },
      shippingNote: { uk: "Розраховується далі", en: "Calculated at checkout", ja: "お会計時に計算します", ar: "يُحتسب عند الدفع" },
      ...
      totalNote: {
        ...
        ar: "يُحتسب الشحن عند الدفع ويُضاف إلى إجمالي طلبك.",
      },
      checkout: { uk: "Перейти до оформлення", en: "Proceed to checkout", ja: "お会計に進む", ar: "المتابعة إلى الدفع" },
      ...
      qty: { uk: "Кількість", en: "Quantity", ja: "数量", ar: "الكمية" },
