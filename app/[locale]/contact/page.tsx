        ...
        <div className="flex flex-col gap-4 pt-2">
          {[
            ...
            <a
              ...
              className="flex items-center justify-between border p-5 transition-colors group"
            ...
            >
              <div>
                <div className="text-xs tracking-widest uppercase mb-1" style={{ color: "var(--text-muted)" }}>
                  {link.label}
                </div>
                <div className="text-sm font-medium" style={{ color: "var(--text)" }}>{link.handle}</div>
              </div>
              <span className="text-lg transition-colors" style={{ color: "var(--border-light)" }}>→</span>
            </a>
          ))}
        </div>
      </div>
